  ...
  function VenueDetails() {
    ...
    return (
      <div className="">
        ...
        <p>{venue.location.city}, {venue.location.country}, {venue.location.continent}</p>
        <p>{venue.rating}</p>
        </div>
        <div className="">
        ...
        <div className="">
        <h1>Address</h1>
        <p>{venue.location.address}, {venue.location.zip}, {venue.location.city}, {venue.location.country}</p>
        </div>
